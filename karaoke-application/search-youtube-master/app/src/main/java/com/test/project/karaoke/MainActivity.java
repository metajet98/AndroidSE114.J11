...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomNavigationViewHelper.disableShiftMode(bottomNavigationView);Menu menu =bottomNavigationView.getMenu();
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId())
                {
                    case R.id.home_search:
                        break;
                    case R.id.offline:
                        Intent intent2 =new Intent(MainActivity.this,Offline.class);
                        startActivity(intent2);
                        break;
                    case R.id.top_trend:
                        Intent intent3 =new Intent(MainActivity.this,TopTrend.class);
        ...
        searchInput.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(actionId == EditorInfo.IME_ACTION_SEARCH){
                    ...
                    mProgressDialog.setMessage("Đang tìm kiếm video "+v.getText().toString());
